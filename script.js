const materiasData = {
  ...
  "Lenguaje Audiovisual 1": {
    correlativas: [
      "Historia de las Artes Audiovisuales 2",
      "Lenguaje Audiovisual 2",
      "Realización 1",
      "Montaje 1"
    ]
  },
  "Fotografía y Cámara 1": {
    correlativas: ["Fotografía y Cámara 2", "Tecnología Digital"]
  },
  "Dibujo y sistemas de representación": { correlativas: [] },
  "Informática": { correlativas: [] },
  "Matemática": { correlativas: [] },
  "Lenguaje Audiovisual 2": {
    correlativas: ["Historia del Teatro Argentino", "Historia del Teatro Universal"]
  },
  "Guión 1": {
    correlativas: ["Montaje 1", "Guión 2"]
  },
  ...
  "Trabajo Social Comunitario 1": {
    correlativas: ["Trabajo Social Comunitario 2"]
  },
  "Historia de las Artes Audiovisuales 2": {
    correlativas: [
  ...
  "Realización 1": {
    correlativas: ["Dirección Actoral", "Realización 2"]
  },
  ...
  "Realización 2": {
    correlativas: [
      "Realización 3",
      "Animación 2D",
      "Mecánica del Movimiento Específica",
      "Pixilatión",
      "Stop Motion",
      "Dirección de Arte y Efectos Especiales",
      "Montaje y Tecnologías Especificas",
      "Desarrollo de Proyectos Cinematográficos de Ficción",
      "Realización Audiovisual Avanzada"
    ]
  },
  "Sonido 2": { correlativas: ["Diseño de Bandas Sonoras 1"] },
  "Gestión y Producción 1": {
    correlativas: [
      "Gestión y Producción 2",
      "Técnicas de Investigación de Audiencia"
    ]
  },
  "Dirección de Arte": { correlativas: [] },
  "Trabajo Social Comunitario 2": {
    correlativas: ["Trabajo Social Comunitario 3"]
  },
  "Estética de los Medios": { correlativas: [] },
  "Sociología": {
    correlativas: ["Metodología de investigación", "Deontología y Ejercicio Profesional"]
  },
  "Montaje 2": {
    correlativas: [
  ...
  "Diseño de Bandas Sonoras 1": {
    correlativas: ["Nuevas tecnologías Audiovisuales"]
  },
  "Metodología de investigación": {
    correlativas: ["Trabajo Final 1: Proyecto de Tesis"]
  },
  ...
  "Legislación": {
    correlativas: ["Deontología y Ejercicio Profesional"]
  },
  "Trabajo Social Comunitario 3": {
    correlativas: ["Trabajo Social Comunitario 4"]
  },
  "Nuevas tecnologías Audiovisuales": { correlativas: [] },
  "Trabajo Final 1: Proyecto de Tesis": {
    correlativas: ["Trabajo Final 2: Realización y Defensa de Tesis"]
  },
...
function actualizarEstado() {
  for (const materia in materiasData) {
    ...
    if (!estados[materia]) {
      const requisitos = Object.entries(materiasData)
        .filter(([k, v]) => v.correlativas.includes(materia))
        .map(([k]) => k);
      const habilitada = requisitos.every(r => estados[r]);
      if (!habilitada) {
